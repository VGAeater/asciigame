...
def approximate_color( c ):
    ...
    for back in colors[:8]:
        for fore in colors:
            ...
            brightness_index = binarySearch( brightness, ddist / dist if dist != 0 else 0 )
            ddist = brightness[ brightness_index ] * dist
            ...
            # distance, fore color, back color, brightness index
            entry = ( approx_dist, fore, back, brightness_index )
